...
def generar_flujo_consecuencias_con_cartas(mes=5, año=2025):
    ...
    try:
        ...
        print(f"❌ Rutas que NO cumplieron: {len(rutas_sin_feedback)}")
          # Crear lista de rutas para consecuencias con datos completos        # Calcular fecha de detección (primer día del mes siguiente)
...
def crear_carta_individual_pdf(filename, ruta, reparto, supervisor, contratista, mes_nombre, año, fecha_deteccion_str):
    ...
    # Usar fecha de detección en lugar de fecha actual
...
"""
    ...
    story.append(Spacer(1, 0.4*inch))    # Firmas simplificadas: Solo Reparto y Supervisor
    firma_data = [
